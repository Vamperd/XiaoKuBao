...
{
  HW_ASSERT(Move_motor_ptr != nullptr, "ptr to feed motor is nullptr",
            Move_motor_ptr);
...
void calcMotorInput() {
  HW_ASSERT(Move_motor_ptr != nullptr, "ptr to Move motor is nullptr",
            Move_motor_ptr);
...
void setCommData() {
  HW_ASSERT(Move_motor_ptr != nullptr, "pointer to Move Motor is nullptr",
            Move_motor_ptr);
