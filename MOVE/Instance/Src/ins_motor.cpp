...
const hw_motor::OptionalParams kMotorParamsMove = {//wait to be modified BLY
...
hw_motor::M3508 unique_motor_Move = hw_motor::M3508(1u, kMotorParamsMove);
hw_motor::Motor* CreateMotorMove() { return &unique_motor_Move; };